...
public class FXMLController {
    ...
    void numeroStudenti(ActionEvent event) {
    	...
    	for (Corso c : iscritti.keySet()) {
    		txtRisultato.appendText(c + "\tIscritti: " + iscritti.get(c) + "\n");
    	}
    }
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	if (codins == null || codins.equals("")) {
    		txtRisultato.appendText("Per favore, inserisci il codice di"
    				+ " un corso!");
    		return;
    	}
    	
    	// aggiungere controllo che il corso inserito esista
    ...
    @FXML
    void stampaStudenti(ActionEvent event) {	// NON FUNZIONA ...
    	txtRisultato.clear();
